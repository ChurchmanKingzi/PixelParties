// ═══════════════════════════════════════════
//  CARD EFFECT: "Censpartan War Counsellor"
//  Creature (Summoning Magic Lv2, Normal) — 100 HP
//
//  EFFECT:
//   "You can only control 1 \"Censpartan War
//    Counsellor\".
//    Other \"War Counsellor\" Creatures you control
...
const CARD_NAME = 'Censpartan War Counsellor';
...
function resyncShield(engine, pi, selfId) {
  ...
  const shouldHave = new Set(
    controlledWarCounsellors(engine, pi)
