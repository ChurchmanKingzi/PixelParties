// ═══════════════════════════════════════════
//  CARD EFFECT: "Harpthenean War Counsellor"
...
//    number of \"War Counsellor\" Creatures you
...
const CARD_NAME = 'Harpthenean War Counsellor';
...
module.exports = {
  ...
  async onCreatureEffect(ctx) {
    ...
    const counsellors = countWarCounsellors(engine, pi);
    const goldGain = GOLD_PER_COUNSELLOR * counsellors;
      ...
      options: [
        {
          ...
          description: `${GOLD_PER_COUNSELLOR} × ${counsellors} "${WC}" Creature${counsellors !== 1 ? 's' : ''} you control.`,
          color: '#ffd700',
        },
        {
          id: 'damage',
    ...
    if (choice.optionId === 'gold') {
      ...
      engine.log('harpthenean_gold', {
        player: ps.username, counsellors, goldGained: goldGain,
      });
      engine.sync();
      return true;
    }
