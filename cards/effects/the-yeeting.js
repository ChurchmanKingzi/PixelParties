...
function _scoreEnemyCard(engine, target) {
  ...
  if ((target.type === 'surprise' || target.type === 'equip') && inst.zone === 'surprise') return 200;
...
// v704: Sammler der Nicht-Helden-Brettkarten (inkl. verdeckter
// Surprises) nach `_targeting-shared.collectNonHeroBoardTargets`
// verschoben — zweiter Nutzer ist Destructive Puppet Shishi.
const { collectNonHeroBoardTargets: _collectBoardTargets } = require('./_targeting-shared');
