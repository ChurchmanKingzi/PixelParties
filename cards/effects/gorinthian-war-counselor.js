// ═══════════════════════════════════════════
//  CARD EFFECT: "Gorinthian War Counselor"
...
//    Counselor\" Creatures, you may once per turn
...
const CARD_NAME = 'Gorinthian War Counselor';
...
module.exports = {
  ...
  spellVisual: {
    impact: { type: 'petrify' }, impactMs: 260,
  },
  ...
  canActivateCreatureEffect(ctx) {
    return countDistinctWarCounselors(ctx._engine, ctx.cardOwner) >= NEEDED_DISTINCT;
  },
  ...
  async onCreatureEffect(ctx) {
    ...
    const distinct = countDistinctWarCounselors(engine, pi);
