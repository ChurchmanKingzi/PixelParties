...
function loadCardEffect(cardName) {
  ...
  try {
    if (fs.existsSync(filePath)) {
      ...
      if (!mod.hooks && !mod.effects && !mod.isPotion && !mod.isEquip && !mod.isTargetingArtifact && !mod.isReaction && !mod.actionCost && !mod.freeActivation && !mod.heroEffect && !mod.creatureEffect && !mod.isTargetRedirect && !mod.resolve) {
